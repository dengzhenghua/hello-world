        ...
        "rows":[
            {
                "id":25,
                "createUser":null,
                "createDate":"2017-07-13 16:02:54",
                "updateUser":null,
                "updateDate":"2017-07-13 16:02:54",
                "sortField":null,
                "order":null,
                "tqmobile":null,
                "title":"tiaopi",
...
| name | type | mandatory | 描述 | 取值范围 |
| - | - | - | - | - ||<br />
 earlyWarning.title | String | Y | 标题 | - |<br />
earlyWarning.emotion | long | Y| 情绪 |  1正面,-1负面,0,中性 |
 earlyWarning.sensitive | long | Y | 敏感 |  1是,0,否 |<br />
earlyWarning.hot | long | Y| 热门 |  1是,0,否 |
 earlyWarning.contentText | String | Y | 内容 | - |<br />
 earlyWarning.programmeId | long | Y | 所属方案id | - |<br />
earlyWarning.popularFeelingClassifyId | long | Y| 所属舆情分类id | -|
 dataSources | long | Y | 数据来源 | 1微博,2客户端,3网站,4外媒,5平台（内网） |<br />
id |long|id| - |
